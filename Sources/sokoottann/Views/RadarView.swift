...
struct PeerDotView: View {
    ...
    private var offsetX: CGFloat { cos(peer.radarAngle(myHeadingDeg: headingDeg)) * (radarSize / 2 * peer.radarDistanceFraction) }
    private var offsetY: CGFloat { sin(peer.radarAngle(myHeadingDeg: headingDeg)) * (radarSize / 2 * peer.radarDistanceFraction) }
